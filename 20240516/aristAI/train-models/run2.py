...
def get_data_from_db():
    db_connection_str = 'mysql+mysqlconnector://root:12345@localhost/youtube_data'
...
class GeminiTextGenerationPipeline:
    ...
    def generate(self, prompt):
        ...
        response = requests.post(url, headers=headers, json=data)
        generated_texts = response.json().get("generated_text", [])
...
def main():
    ...
    response, referred_ids = pipeline.generate("How can Federal Reserve help people?")
